          ...
          return (
            ...
            >
              <div className="flex items-center justify-between mb-1.5 sm:mb-2 gap-1">
                <span className="text-[10px] sm:text-xs font-medium text-slate-500 uppercase tracking-wide leading-tight">
                  {card.label}
                </span>
              ...
              {card.isAlert && (
                <span className="inline-block mt-1 sm:mt-2 text-[10px] sm:text-xs font-medium text-amber-600 bg-amber-100 px-1.5 sm:px-2 py-0.5 rounded-full">
                  ⚠ Requires Review
                </span>
              )}
            </div>
