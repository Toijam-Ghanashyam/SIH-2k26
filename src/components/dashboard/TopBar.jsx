...
const TopBar = ({ onRerun, isRunning }) => {
  return (
    <header className="bg-navy-900 border-b border-navy-700 px-4 sm:px-6 py-3 flex items-center justify-between sticky top-0 z-[1010]">
      {/* Product wordmark — matches the landing page Navbar */}
      <Link to="/" className="flex items-center gap-2 group">
        <span className="text-white text-xl font-bold tracking-tight group-hover:text-teal-300 transition-colors">
          GeoSync
        </span>
